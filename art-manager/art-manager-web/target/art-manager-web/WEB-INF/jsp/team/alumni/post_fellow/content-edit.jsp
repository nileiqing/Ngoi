	...
	<form id="contentEditForm" class="itemForm" method="post">
	    ...
	    <table cellpadding="5">
	        ...
	        <tr>
	            ...
	            <td id="J_content2">
	                <textarea style="width:1000px;height:251px;visibility:hidden;" id="content" name="content"></textarea>
	            </td>
	        </tr>
			<tr>
				<td id="J_content_zh1">中文内容:</td>
				<td id="J_content_zh2">
					<textarea style="width:1000px;height:251px;visibility:hidden;" id="contentZhCn" name="contentZhCn"></textarea>
				</td>
			</tr>
	    </table>
	</form>
