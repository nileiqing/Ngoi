 ...
 * Generated at: 2019-08-20 05:05:53 UTC
...
public final class content_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tif(categoryId==\"11\"||categoryId==\"12\"||(categoryId>=19&&categoryId<=28)||(categoryId>=29&&categoryId<=33)||categoryId==\"34\"||categoryId==\"35\"||categoryId==\"8\"||categoryId==\"9\"){//此处是只有一个内容的情况（其中的内容标题是用来对此词条做描述用的） Lab introduction 实验室介绍+Research 也做成员介绍处的显示 34、35为Event模块 8为Activities模块 9为Open Position模块\n");
      out.write("\t\t\t\n");
      ...
      out.write("\t\t\t}else if(categoryId>=29&&categoryId<=33){\n");
      out.write("\t\t\t\t$(\"#J_title1\").html(\"序号\");\n");
      out.write("\t\t\t}else{\n");
      ...
      out.write("\t\t\tvar hiddentype;\n");
      out.write("\t\t\tif(categoryId==\"11\"||categoryId==\"12\"||categoryId==\"5\"||categoryId==\"6\"||categoryId==\"7\"||categoryId==\"8\"||categoryId==\"9\"||categoryId==\"34\"||categoryId==\"35\"){//此处是只有一个内容的情况（其中的内容标题是用来对此词条做描述用的） Lab introduction 实验室介绍+Research thrusts研究课题  Publication Events Activities都用到\n");
      ...
      out.write("\t\t\t\t\n");
      out.write("\t\t\t}else if((categoryId>=19&&categoryId<=28)||(categoryId>=29&&categoryId<=33)){\n");
      out.write("\t\t\t//此处为成员介绍，因为有模板所以只显示标题即可\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'titleDesc');//隐藏标题详述\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'pic');//显示第一个图片\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'pic2');//隐藏对第二个图片\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'title');//显示对应的标题\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'subTitle');//显示副标题\n");
      out.write("\t\t\t}else if(categoryId==\"10\"){\n");
