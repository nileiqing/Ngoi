...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false" style="padding:10px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="contact_List" data-options="toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'/content/query/list',queryParams:{categoryId:${categoryId}}">
		    <thead>
		        <tr>
...
TT.createWindow({
    ...
    iconCls:'icon-edit',
    handler:function(){
    	var ids = TT.getSelectionsIds("#contact_List");
    	if(ids.length == 0){
		...
		TT.createWindow({
			...
			onLoad : function(){
				var data = $("#contact_List").datagrid("getSelections")[0];
