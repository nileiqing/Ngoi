...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false" style="padding:10px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="post_fellow_List" data-options="toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'/content/query/list',queryParams:{categoryId:${categoryId}}">
		    <thead>
		        <tr>
...
TT.createWindow({
    ...
    iconCls:'icon-edit',
    handler:function(){
    	var ids = TT.getSelectionsIds("#post_fellow_List");
    	if(ids.length == 0){
		...
		TT.createWindow({
			...
			onLoad : function(){
				var data = $("#post_fellow_List").datagrid("getSelections")[0];
            	...
            	$.post("/content/delete",params, function(data){
        			if(data.status == 200){
        				$.messager.alert('提示','删除内容成功!',undefined,function(){
        					$("#post_fellow_List").datagrid("reload");
        				});
        			}
        		});
    	    }
