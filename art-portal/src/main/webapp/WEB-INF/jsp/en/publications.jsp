...
<body>
	...
	<header>
		...
		<div class="navbar">
			<ul>
				...
				<li style="float:right"><a href="<%=basePath%>zh/publications.html" target="_self">中文版</a></li>
			</ul>
		</div>
	</header>
	<!-- 主体部分 -->
	...
	<div class="footer">
		...
		&nbsp;-&nbsp;
		<a href="#" target="_self">Publication</a>
		&nbsp;-&nbsp;
...
<script type="text/javascript" src="<%=basePath%>js/en/ngoipublications.js"></script>
