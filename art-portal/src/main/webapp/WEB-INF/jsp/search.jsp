		...
		<h3 class="am-u-sm-12 mtitle">
			<div class="am-g">
				<div class="am-u-md-3" style="padding-left:0px;">
					<i class="am-icon-newspaper-o" style="background-color: #EB2222"></i>NEWS<span class="newsmodeltitle">搜索结果</span>
				</div>
				<div class="am-u-md-9">
					<div class="breadcrumbs" typeof="BreadcrumbList" vocab="http://schema.org/">
						...
						<span property="itemListElement" typeof="ListItem">
							<span property="name" class="newsmodeltitle">搜索结果</span>
...
<script type="text/javascript" src="<%=basePath%>js/jsonajaxsearch.js"></script>
