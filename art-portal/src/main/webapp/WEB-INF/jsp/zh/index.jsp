	...
	<header>
		...
		<div class="navbar">
			<ul>
				...
				<li><a href="<%=basePath%>team.html" target="_self">成员信息</a></li>
				<!-- <li><a href="#" target="_self">AI FOR WIRELESS</a></li> -->
				<li><a href="<%=basePath%>research.html" target="_self">研究项目</a></li>
				<li><a href="<%=basePath%>publications.html" target="_self">研究成果</a></li>
				<%--<li><a href="<%=basePath%>events.html" target="_self">EVENTS</a></li>
				<li><a href="<%=basePath%>activities.html" target="_self">ACTIVITY</a></li>--%>
				<li><a href="<%=basePath%>openpositions.html" target="_self">招生信息</a></li>
				<li><a href="<%=basePath%>contact.html" target="_self">联系我们</a></li>
			</ul>
		</div>
	</header>
	<!-- 主体部分 -->
