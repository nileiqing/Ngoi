	...
	<header>
		...
		<div class="navbar">
			<ul>
				...
				<li><a href="#" target="_self">成员信息</a></li>
				...
				<li style="float:right"><a href="<%=basePath%>team.html" target="_self">English</a></li>
			</ul>
		</div>
	</header>
	<!-- 主体部分 -->
...
<script type="text/javascript" src="<%=basePath%>js/zh/ngoiteamlist.js"></script>
