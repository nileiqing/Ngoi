		...
		<h3 class="am-u-sm-12 mtitle">
			<div class="am-g">
				<div class="am-u-md-3" style="padding-left:0px;">
					<i class="am-icon-newspaper-o" style="background-color: #EB2222"></i>NEWS<span class="newsmodeltitle">学院特色</span>
				</div>
				<div class="am-u-md-9">
	...
	<div class="side-bar am-u-md-3">
		<div class="events am-g" style="margin-bottom: 3rem;">
			<h3 class="am-u-sm-12 mtitle">
				...
				<span>学院特色</span>
				<a style="float:right;margin-top: 10px;" href="<%=basePath%>school/special.html"><i class="am-icon-link elink"></i></a>
			</h3>
...
<script type="text/javascript" src="<%=basePath%>js/jsonajaxfeature.js"></script>
