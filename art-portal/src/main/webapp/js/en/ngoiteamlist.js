	...
	$.getJSON(allurl + "getalllist.html?categoryId="+teamcid+"&ordertype="+ordertype, 
				function(data) {
	        		...
	        		if(item.categoryId==facultycurid){
	        			facultystr+=item.content+"<b><hr class=mainlefthr></b>";

	        		}else if(item.categoryId==pdfcurid){
	        			pdfcurstr+=item.content+"<b><hr class=mainlefthr></b>";
	        		}else if(item.categoryId==PhDStucurid){
	        			PhDStucurstr+=item.content+"<b><hr class=mainlefthr></b>";
	        		}else if(item.categoryId==underStuCurid){
	        			underStuCurstr+=item.content+"<b><hr class=mainlefthr></b>";
	        		}else if(item.categoryId==aluPdfid){
	        			aluPdfstr+=item.content+"<b><hr class=mainlefthr></b>";
	        		}else if(item.categoryId==alugraStuid){
	        			alugraStustr+=item.content+"<b><hr class=mainlefthr></b>";
	        		}else if(item.categoryId==aluUnderStuid){
	        			aluUnderStustr+=item.content+"<b><hr class=mainlefthr></b>";
	        		}else if(item.categoryId==AffStuAndFacid){
	        			AffStuAndFacstr+=item.content+"<b><hr class=mainlefthr></b>";
	        		}else if(item.categoryId==visitorid){
	        			visitorstr+=item.content+"<b><hr class=mainlefthr></b>";
	        		}
		        });
					if(facultystr!=""){
						facultystr="<div class=person_type_title>Faculty</div><b><hr class=mainlefthr></b>"+facultystr;
						finalHtml+=facultystr;
					}
					if(pdfcurstr!=""){
						pdfcurstr="<div class=person_type_title>Postdoctoral Fellows</div><b><hr class=mainlefthr></b>"+pdfcurstr;
						finalHtml+=pdfcurstr;
					}
					if(PhDStucurstr!=""){
						PhDStucurstr="<div class=person_type_title>PhD Students</div><b><hr class=mainlefthr></b>"+PhDStucurstr;
						finalHtml+=PhDStucurstr;
					}
					if(underStuCurstr!=""){
						underStuCurstr="<div class=person_type_title>Undergraduate Students</div><b><hr class=mainlefthr></b>"+underStuCurstr;
						finalHtml+=underStuCurstr;
					}
					if(aluPdfstr!=""||alugraStustr!=""||aluUnderStustr!=""){
						finalHtml+="<div class=person_type_title>Alumni</div><b><hr class=mainlefthr></b>";
						if(aluPdfstr!=""){
							aluPdfstr="<div class=person_type_title_alumni>Postdoctoral Fellows</div><b><hr class=mainlefthr></b>"+aluPdfstr;
							finalHtml+=aluPdfstr;
						}
						if(alugraStustr!=""){
							alugraStustr="<div class=person_type_title_alumni>Graduate Students</div><b><hr class=mainlefthr></b>"+alugraStustr;
							finalHtml+=alugraStustr;
						}
						if(aluUnderStustr!=""){
							aluUnderStustr="<div class=person_type_title_alumni>Undergraduate Students</div><b><hr class=mainlefthr></b>"+aluUnderStustr;
							finalHtml+=aluUnderStustr;
						}
					}
					
					if(AffStuAndFacstr!=""){
						AffStuAndFacstr="<div class=person_type_title>Affiliated Students and Faculty</div><b><hr class=mainlefthr></b>"+AffStuAndFacstr;
						finalHtml+=AffStuAndFacstr;
					}
		       		if(visitorstr!=""){
		       			visitorstr="<div class=person_type_title>Visitors</div><b><hr class=mainlefthr></b>"+visitorstr;
