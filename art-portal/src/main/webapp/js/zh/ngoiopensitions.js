...
//获取空缺职位信息
	$.getJSON(allurl + "getlistbyorder.html?categoryId="+openpositioncid+"&ordertype="+0,
				function(data) {
					var openpositionstr="";
					$.each(data,function(i,item){
						openpositionstr+="<div class=openposition_list_title><b>"+item.titleZhCn+"</b></div><b><hr class=mainlefthr></b><div class=openposition_list_content>"+item.contentZhCn+"</div>";
