 ...
 * Generated at: 2019-10-07 07:55:37 UTC
...
public final class research_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t<style>\n");
      out.write("\t\t.navbar li:nth-child(3) {\n");
      out.write("\t\t\tbackground-color: #fff;\n");
      out.write("\t\t\tborder-bottom: 2px solid #52a1d2;\n");
      out.write("\t\t}\n");
      out.write("\t\t.navbar li:nth-child(3) a { \n");
      ...
      out.write("\t\t\t\t<li><a href=\"#\" target=\"_self\">RESEARCH</a></li>\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.print(basePath);
      ...
      out.write("\t\t\t\t\t<div class=\"research_page_first_title\">Research Projects</div>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<div class=\"research_desc_list\"></div>\t\t\n");
      out.write("\t\t\t\t<!-- \t<div class=\"research_desc\">\n");
      out.write("\t\t\t\t\t<div class=\"research_desc_title\"><a href=\"#\">Big Data Analytics for Optimized Planning of Smart, Sustainable, and Connected Communities</a></div>\n");
      out.write("\t\t\t\t\t<div class=\"research_desc_content\">\n");
      out.write("\t\t\t\t\t\t<div><span><strong>Sponsored by:</strong></span><p>National Science Foundation (NSF)</p></div>\n");
      out.write("\t\t\t\t\t\t<div><span><strong>Collaborators:</strong></span><p>Harpreet Dhillon (Virginia Tech)</p></div>\n");
      out.write("\t\t\t\t\t\t<div><img src=\"http://www.netsciwis.com/_/rsrc/1484690909705/research/mainDRAWING.jpg?height=251&width=400\" >The goal of this project is to develop a foundational framework for the modeling and performance analysis of the Internet of Things (IoT) that will facilitate the management of resources, such as energy and computation, jointly across its cyber and physical realms. By leveraging interdisciplinary tools from stochastic geometry, distributed optimization, and operations research, the proposed framework will yield a number of results that include new statistical models and CPS performance metrics for characterizing the cyber-physical operation of IoT as well as novel distributed optimization algorithms that will adapt the cyber-physical operational state of the IoT devices to the dynamics of the CPS environment, while being cognizant of their stringent resource constraints.</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div> \n");
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.print(basePath);
      out.write("js/ngoiresearchlist.js\"></script>\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.print(basePath);
