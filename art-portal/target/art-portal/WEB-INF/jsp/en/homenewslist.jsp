...
<body>
	...
	<div class="main">
		<div class="main-in">
			...
			<!-- 主体左侧内容 -->
			<div class="mainleft">
				<div class="listpage-news">News</div>
				<div class="newslist-main">
					Latest news and updates at Network Science and wireless security group.
...
<script type="text/javascript" src="<%=basePath%>js/en/ngoihomenewslist.js"></script>
