...
var publicationcid=6//出版物栏目的Id
	...
	var patentsid=33;//专利
var enentscid=6//event对应的categoryid
...
//获取EventsImg信息
	...
	$.getJSON(allurl + "getlistbyorder.html?categoryId="+eventimgscid+"&ordertype="+ordertype, 
				function(data) {
					/*此处的是只获取一个轮播图*/
					$(".carousel-inner").html(data[0].content);
		//获取图片的个数
      var listr="";
      var imglist=$(".carousel-inner img");
      for (var i=0;i<imglist.length;i++) {

        listr+="<li data-target=#carousel-example-generic data-slide-to="+i+"></li>";

      }
      //这是 圆点按钮
      $(".carousel-indicators").html(listr);
