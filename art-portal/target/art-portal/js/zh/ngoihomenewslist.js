...
//获取新闻列表
	...
	ajax=$.getJSON(allurl + "getlistbyorder.html?categoryId="+innewcid+"&ordertype="+ordertype, 
		        ...
		        var news = "";
	        	$.each(data,function(i,item){
	        		news+="<div class=listnews-desc><div class=listnews-desc-title><a href="+allurl+ "zh/home/news/"+item.id+".html>"+item.title+"</a><span class=newsdate>发布于 "+item.subTitle+"</span></div>"
