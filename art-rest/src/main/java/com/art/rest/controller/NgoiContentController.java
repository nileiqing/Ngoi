...
public class NgoiContentController {
	...
	//根据传过来的分类id该分类下的所有叶子节点子内容,一般正序排列
	@RequestMapping(value="/publication/list",method=RequestMethod.GET,produces="text/html;charset=UTF-8")
	@ResponseBody
	public String getPublicationContentListsByOrder(long categoryId,int ordertype) {
		//List<TContent> list=contentService.getContentListByCategoryId(categoryId);
		List<TContent> list =ngoiContentService.getPublicationContentListByOrder(categoryId, ordertype);
		String json=JsonUtils.objectToJson(list);
		return json;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
	}
	//根据contentid查询某一条记录
